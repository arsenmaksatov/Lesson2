...
import com.example.lesson14.databinding.FragmentSecondBinding;
...
public class SecondFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Start = AnimationUtils.loadAnimation(requireContext(), R.anim.start_nim);
        binding.secondFragment.setAnimation(Start);
        data();
    }
